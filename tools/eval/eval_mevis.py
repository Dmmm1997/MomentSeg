...
sys.path.insert(0, '/root/paddlejob/workspace/env_run/daiming/project/Sa2VA')
    ...
    while not q.empty():
        ...
        if generate_video:
            ...
            for pred_mask_, gt_mask_, frame_name_ in zip(pred_masks, gt_masks, vid['frames']):
                ori_path = f'./data/video_datas/mevis/valid_u/JPEGImages/{vid_name}/{frame_name_}.jpg'
...
if __name__ == '__main__':
    ...
    video_pred_path = os.path.join(osp.dirname(args.pred_path), "mevis_video_vis")
