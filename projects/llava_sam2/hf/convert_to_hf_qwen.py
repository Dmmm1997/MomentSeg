...
def main():
    ...
    from projects.llava_sam2.hf.models.modeling_sa2va_chat_qwen2_5vl import Sa2VAChatQwen2_5VLModel
    config_dict = {}
    mllm_config = Qwen2_5_VLConfig.from_pretrained(cfg.path)
    # mllm_config.vocab_size = len(model.tokenizer)
    ...
    config_dict['auto_map'] = \
        {'AutoConfig': 'configuration_sa2va_chat_qwen2_5vl.Sa2VAChatQwen2_5VLConfig',
         'AutoModel': 'modeling_sa2va_chat_qwen2_5vl.Sa2VAChatQwen2_5VLModel',
         'AutoModelForCausalLM': 'modeling_sa2va_chat_qwen2_5vl.Sa2VAChatQwen2_5VLModel'}
    
    sa2va_hf_config = Sa2VAChatQwen2_5VLConfig(
        **config_dict
    )
    hf_sa2va_model = Sa2VAChatQwen2_5VLModel(sa2va_hf_config, model=model.mllm.model)
