...
class Sa2VAChatQwen2_5VLModel(PreTrainedModel):
    config_class = Sa2VAChatQwen2_5VLConfig
    _supports_flash_attn_2 = True
    supports_gradient_checkpointing = True

    def __init__(self, config: Sa2VAChatQwen2_5VLConfig, use_flash_attn=True):
    ...
    def preparing_for_generation(self, tokenizer, max_new_tokens=2048, torch_dtype=torch.bfloat16):
        ...
        self.preprocessor = QwenPrepocessor(self.model_path, self.min_pixels, self.max_pixels)
    ...
    def predict_forward(
            ...
            tokenizer=None,
            num_frames=5,
            inference_mode="video", # (multi-frame or video)
    ):
