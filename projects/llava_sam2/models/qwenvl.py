...
class Qwen2_5_VL(InternVL_V1_5):
    ...
    def forward(self, data, data_samples=None, mode='loss', fast_token_idx=None):
        ...
        outputs = self.model(
            ...
            pixel_values=pixel_values[0] if pixel_values is not None else None,
            pixel_values_videos=pixel_values_videos[0] if pixel_values_videos is not None else None,
            labels=labels,
            use_cache=use_cache,
            output_hidden_states=True,
            image_grid_thw=image_grid_thw[0] if image_grid_thw is not None else None,
