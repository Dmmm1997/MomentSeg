...
SEG_PROMPT = "<video>\nThis is a low-resoluton video. <image>\nPlease segment {} in this video."
SEG_SENTENCE_PROMPT = "<video>\nThis is a low-resoluton video. <image>\nPlease segment {} in this video."
# SEG_PROMPT = "<image>\nPlease segment {} in this video."
# SEG_SENTENCE_PROMPT = "<image>\nPlease segment {} in this video."
# SEG_SENTENCE_PROMPT = "<image>\n {} Please segment the target in this video."
FIND_PROMPT = "<video>\nHere is a low-resolution video you can refer to. Can you find the key frames range of the text query '{}' in this video"
...
class RefVOSDataset(BaseEvalDataset):
    ...
    def __getitem__(self, index):
        ...
        data_dict['text_prompt'] = SEG_PROMPT.format(exp) if '?' not in exp else SEG_SENTENCE_PROMPT.format(exp)
